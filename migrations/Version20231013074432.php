 ...
 */
final class Version20231013074432 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier (id INT AUTO_INCREMENT NOT NULL, prix_panier NUMERIC(5, 2) NOT NULL, nom_produit_panier VARCHAR(255) NOT NULL, prix_produit_panier NUMERIC(5, 2) NOT NULL, type_produit_panier VARCHAR(255) NOT NULL, image_produit_panier VARCHAR(255) NOT NULL, quantite_produit_panier INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
